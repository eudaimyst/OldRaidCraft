package Levels 
{
	...
	public class SpellSelect extends World 
	{
		...
		public function SpellSelect() 
		{
			...
			add (new HUD.SpellButton("", 0, 3, 1));
			add (new HUD.SpellButton("", 0, 4, 1));
			add (new HUD.SpellButton("", 0, 5, 1));
			add (new HUD.SpellButton("", 0, 1, 2));
			add (new HUD.SpellButton("", 0, 2, 2));
			add (new HUD.SpellButton("", 0, 3, 2));
			add (new HUD.SpellButton("", 0, 4, 2));
			add (new HUD.SpellButton("", 0, 5, 2));
			add (new HUD.SpellButton("", 0, 1, 3));
			add (new HUD.SpellButton("", 0, 2, 3));
			add (new HUD.SpellButton("", 0, 3, 3));
			add (new HUD.SpellButton("", 0, 4, 3));
			add (new HUD.SpellButton("", 0, 5, 3));
